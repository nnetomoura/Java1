...
public abstract class menuAcompanhamentos implements todosOsMetodos {

	public menuAcompanhamentos() {
		super();
	...
	public void tipoMenu() {
		...
		do {
			...
			System.out.println("I. Menu de acompanhamentos (arroz, feijão, macarrão, cuscuz)");
	...
	abstract public void aspectoComida(); 
	{
		...
		do {
			...
			System.out.println("****Avalie o menu abaixo de acordo com a sua opinião****");
			System.out.println("Sobre o aspecto visual dos acompanhamentos servidos na escola: Que nota você daria?" );
			System.out.println("1. Péssimo" + "\n2. Ruim" + "\n3. Razoável " 
					+ "\n4. Bom"+"\n5. Excelente");
			Scanner leia = new Scanner(System.in);
			System.out.println("Digite a opção escolhida: ");
	...
	{		
			System.out.println("****Avalie o menu abaixo de acordo com a sua opinião****");
			System.out.println("Os acompanhamentos vêm sendo servidos com frequência?");
